 ...
 */
public class DirtyFixedDemo {

    private static final Logger log = LoggerFactory.getLogger(DirtyFixedDemo.class);

    public static final long SLEEP_TIME_IN_TWO_SEC = 2;
    private static final long SLEEP_TIME_IN_ONE_SEC = 1;

    public static void main(String[] args) {
        final DirtyFixed d = new DirtyFixed("oldName", "oldPass");
        new Thread(() -> {
            log.info(d.getValue());
