...
/**   
 * @Title: RandomFileDemo.java

 * @Description: 随机访问类之员工信息类的使用
...
public class RandomFileDemo
{
    public static void main(String[] args) throws Exception
    {
        ...
        ra.write(e1.name.getBytes("iso-8859-1")) ;
        ra.writeInt(e1.age) ;
        ra.write(e2.name.getBytes("iso-8859-1")) ;
        ra.writeInt(e2.age) ;
        ra.write(e3.name.getBytes("iso-8859-1")) ;
        ra.writeInt(e3.age) ;
        ra.close() ;
